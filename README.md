...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/txt-2-img
```

A live public deployment of this template is available at [https://txt-2-img.templates.workers.dev](https://txt-2-img.templates.workers.dev)
